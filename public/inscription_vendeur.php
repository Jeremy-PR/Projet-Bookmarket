...
<body class="bg-neutral-black flex items-center justify-center h-screen">
  <div class="bg-primary-grey p-8 rounded-2xl shadow-md w-96">
    <h1 class="text-2xl font-bold mb-6 text-neutral-white text-center">Inscription - Vendeur</h1>
    <form action="../process/process_inscription_vendeur.php" method="POST" class="space-y-4">
      ...
      <input type="text" name="entreprise" placeholder="Entreprise" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-red" required>
      <input type="text" name="adresse_entreprise" placeholder="Adresse de l'entreprise" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-red" required>
      <input 
        type="tel" 
        name="phone" 
