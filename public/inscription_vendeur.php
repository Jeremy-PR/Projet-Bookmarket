...
<body class="min-h-screen flex items-center justify-center bg-neutral-black">
  <form action="../process/process_inscription_vendeur.php" method="POST" class="bg-neutral-black p-6 rounded-lg shadow-md space-y-4">
    ...
    <input type="text" name="Entreprise" placeholder="Entreprise" class="border border-gray-300 rounded w-full p-2">
    <input type="text" name="Adresse entreprise" placeholder="Adresse entreprise" class="border border-gray-300 rounded w-full p-2">
