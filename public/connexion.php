...
<body class="bg-neutral-black flex items-center justify-center h-screen">
    <div class="bg-primary-grey p-8 rounded-2xl shadow-md w-96">
        ...
        <form action="process_connexion.php" method="POST">
            ...
            <a href="process_connexion.php" class="block w-full text-center bg-primary-red text-white py-2 rounded-lg hover:bg-primary-red transition duration-200">Se connecter</a>
        </form>
